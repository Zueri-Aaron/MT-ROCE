...
set_property -dict [list   CONFIG.C_PROBE20_WIDTH {32} CONFIG.C_PROBE19_WIDTH {32} CONFIG.C_PROBE18_WIDTH {32} CONFIG.C_PROBE15_WIDTH {32} CONFIG.C_PROBE11_WIDTH {64} CONFIG.C_PROBE10_WIDTH {512} CONFIG.C_PROBE7_WIDTH {96} CONFIG.C_PROBE3_WIDTH {64} CONFIG.C_PROBE2_WIDTH {512} CONFIG.C_NUM_OF_PROBES {21} CONFIG.Component_Name {rdma_ack} CONFIG.C_INPUT_PIPE_STAGES {1} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2} CONFIG.C_DATA_DEPTH {4096}] [get_ips rdma_ack]
