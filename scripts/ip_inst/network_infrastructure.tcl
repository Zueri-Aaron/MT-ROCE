...
## MT zaaron
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name rdma_ack
set_property -dict [list     CONFIG.C_PROBE31_WIDTH {96}  CONFIG.C_PROBE20_WIDTH {32} CONFIG.C_PROBE19_WIDTH {32} CONFIG.C_PROBE18_WIDTH {32} CONFIG.C_PROBE17_WIDTH {32} CONFIG.C_PROBE16_WIDTH {32} CONFIG.C_PROBE15_WIDTH {5} CONFIG.C_PROBE14_WIDTH {32} CONFIG.C_PROBE13_WIDTH {32} CONFIG.C_PROBE11_WIDTH {64} CONFIG.C_PROBE10_WIDTH {512} CONFIG.C_PROBE7_WIDTH {96} CONFIG.C_PROBE3_WIDTH {64} CONFIG.C_PROBE2_WIDTH {512} CONFIG.C_NUM_OF_PROBES {32} CONFIG.Component_Name {rdma_ack} CONFIG.C_INPUT_PIPE_STAGES {1} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2} CONFIG.C_DATA_DEPTH {4096}] [get_ips rdma_ack]

create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name mux_ila
set_property -dict [list     CONFIG.C_PROBE40_WIDTH {64} CONFIG.C_PROBE39_WIDTH {512} CONFIG.C_PROBE35_WIDTH {64}  CONFIG.C_PROBE34_WIDTH {512} CONFIG.C_PROBE30_WIDTH {64} CONFIG.C_PROBE29_WIDTH {512} CONFIG.C_PROBE26_WIDTH {96} CONFIG.C_PROBE23_WIDTH {96} CONFIG.C_PROBE19_WIDTH {64} CONFIG.C_PROBE18_WIDTH {512} CONFIG.C_PROBE14_WIDTH {64} CONFIG.C_PROBE13_WIDTH {512} CONFIG.C_PROBE9_WIDTH {64} CONFIG.C_PROBE8_WIDTH {512} CONFIG.C_PROBE5_WIDTH {128} CONFIG.C_PROBE2_WIDTH {128} CONFIG.C_NUM_OF_PROBES {45} CONFIG.Component_Name {mux_ila} CONFIG.C_INPUT_PIPE_STAGES {1} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2} CONFIG.C_DATA_DEPTH {4096}] [get_ips mux_ila]

create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name retrans_mux_ila
set_property -dict [list     CONFIG.C_PROBE26_WIDTH {64} CONFIG.C_PROBE25_WIDTH {512} CONFIG.C_PROBE21_WIDTH {28} CONFIG.C_PROBE8_WIDTH {20} CONFIG.C_PROBE7_WIDTH {20} CONFIG.C_PROBE5_WIDTH {64} CONFIG.C_PROBE4_WIDTH {512} CONFIG.C_NUM_OF_PROBES {30} CONFIG.Component_Name {retrans_mux_ila} CONFIG.C_INPUT_PIPE_STAGES {1} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2} CONFIG.C_DATA_DEPTH {4096}] [get_ips retrans_mux_ila]
